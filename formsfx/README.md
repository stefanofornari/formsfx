...
`labelSpan(int)` | Determines, how many columns the field label should span on the view layer.
`freeText(boolean)` | Determines, whether the user can enter custom values for selection fields. **Applicable only to `SingleSelectionField`.**
