...
public class SimpleListViewControlTest extends AbstractFxTest {

    private MultiSelectionField<String> field;
    ...
    protected void init(Stage stage, javafx.scene.layout.BorderPane root) {
        field = Field.ofMultiSelectionType(Arrays.asList("one", "two", "three")).label("Test label");
        createForm(field);
    }

    @Test
    public void labelSpan_default_is_2() {
        SimpleListViewControl<String> control = new SimpleListViewControl<>();
    ...
    public void label_uses_labelSpan_in_layout_when_columns_geq_3() {
        MultiSelectionField<String> testField = Field.ofMultiSelectionType(Arrays.asList("one", "two")).label("Test").span(5);
        SimpleListViewControl<String> control = new SimpleListViewControl<>();
        control.labelSpan(3);
    ...
    public void label_uses_labelSpan_from_field_in_layout_when_columns_geq_3() {
        MultiSelectionField<String> testField = Field.ofMultiSelectionType(Arrays.asList("one", "two")).label("Test").span(5).labelSpan(4);
        SimpleListViewControl<String> control = new SimpleListViewControl<>();
        control.setField(testField);
