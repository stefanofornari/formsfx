...
public class IntegerSliderControlTest extends AbstractFxTest {
    ...
    public void labelSpan_default_is_2() {
        IntegerSliderControl control = new IntegerSliderControl(0, 10);
    ...
    public void label_uses_labelSpan_in_layout_when_columns_geq_3() {
        IntegerField testField = Field.ofIntegerType(5).label("Test").span(5);
        IntegerSliderControl control = new IntegerSliderControl(0, 10);
        control.labelSpan(3);
    ...
    public void label_uses_labelSpan_from_field_in_layout_when_columns_geq_3() {
        IntegerField testField = Field.ofIntegerType(5).label("Test").span(5).labelSpan(4);
        IntegerSliderControl control = new IntegerSliderControl(0, 10);
        control.setField(testField);
