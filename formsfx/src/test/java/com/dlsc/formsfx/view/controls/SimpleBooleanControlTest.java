...
public class SimpleBooleanControlTest extends AbstractFxTest {
    ...
    protected void init(Stage stage, javafx.scene.layout.BorderPane root) {
        field = Field.ofBooleanType(true).label("Test label");
        createForm(field);
    }

    @Test
    public void labelSpan_default_is_2() {
        SimpleBooleanControl control = new SimpleBooleanControl();
        then(control.labelSpan()).isEqualTo(2);
    }

    @Test
    public void labelSpan_can_be_set_via_constructor() {
        SimpleBooleanControl control = new SimpleBooleanControl(3);
    ...
    public void label_uses_labelSpan_in_layout_when_columns_geq_3() {
        BooleanField testField = Field.ofBooleanType(true).label("Test").span(5);
        // SimpleBooleanControl control = new SimpleBooleanControl(3);
        SimpleBooleanControl control = new SimpleBooleanControl();
        control.labelSpan(3);
    ...
    public void label_uses_labelSpan_from_field_in_layout_when_columns_geq_3() {
        BooleanField testField = Field.ofBooleanType(true).label("Test").span(5).labelSpan(4);
        SimpleBooleanControl control = new SimpleBooleanControl();
        control.setField(testField);
