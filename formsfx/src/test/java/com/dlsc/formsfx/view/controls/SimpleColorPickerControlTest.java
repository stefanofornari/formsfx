...
public class SimpleColorPickerControlTest extends AbstractFxTest {
    ...
    protected void init(Stage stage, javafx.scene.layout.BorderPane root) {
        field = Field.ofStringType("").label("Test label");
        createForm(field);
    }

    @Test
    public void labelSpan_default_is_2() {
        SimpleColorPickerControl control = new SimpleColorPickerControl(Color.WHITE);
    ...
    public void label_uses_labelSpan_in_layout_when_columns_geq_3() {
        StringField testField = Field.ofStringType("").label("Test").span(5);
        SimpleColorPickerControl control = new SimpleColorPickerControl(Color.WHITE);
        control.labelSpan(3);
    ...
    public void label_uses_labelSpan_from_field_in_layout_when_columns_geq_3() {
        StringField testField = Field.ofStringType("").label("Test").span(5).labelSpan(4);
        SimpleColorPickerControl control = new SimpleColorPickerControl(Color.WHITE);
        control.setField(testField);
