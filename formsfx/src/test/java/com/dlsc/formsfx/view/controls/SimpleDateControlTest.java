...
public class SimpleDateControlTest extends AbstractFxTest {
    ...
    protected void init(Stage stage, javafx.scene.layout.BorderPane root) {
        field = Field.ofDate(LocalDate.now()).label("Test label");
        createForm(field);
    }

    @Test
    public void labelSpan_default_is_2() {
        SimpleDateControl control = new SimpleDateControl();
    ...
    public void label_uses_labelSpan_in_layout_when_columns_geq_3() {
        DateField testField = Field.ofDate(LocalDate.now()).label("Test").span(5);
        SimpleDateControl control = new SimpleDateControl();
        control.labelSpan(3);
    ...
    public void label_uses_labelSpan_from_field_in_layout_when_columns_geq_3() {
        DateField testField = Field.ofDate(LocalDate.now()).label("Test").span(5).labelSpan(4);
        SimpleDateControl control = new SimpleDateControl();
        control.setField(testField);
