...
public class SimpleListViewControl<V> extends SimpleControl<MultiSelectionField<V>, ListView<String>> {
    ...
    /**
     * Creates a new SimpleListViewControl with the default label span of 2.
     */
    ...
    /**
     * Creates a new SimpleListViewControl with the specified label span.
     *
     * @param labelSpan the number of columns the label should span
     */
    public SimpleListViewControl(int labelSpan) {
        super(labelSpan);
